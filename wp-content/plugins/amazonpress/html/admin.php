	...
	<form action='' method='POST'>
		...
		<div id="amazonPressSearch" style='display:none;'>
			<table class='widefat' style='width: 600px;'>
				...
				<tr>
					<td><strong>Default Tags:</strong><br/><small>Enter a couple default tags seperated by commas to be used on articles not having any specific tags. (Brand names works best, used to find products related to these tags)</small></td>
				...
				<tr>
					<td><strong>Tip the Developer:</strong><br/>
						...
						you can help to support future development of this plugin.</small></td>
